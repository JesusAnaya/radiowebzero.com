...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('google_plus', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Hour'
        db.delete_table(u'accounts_hour')
